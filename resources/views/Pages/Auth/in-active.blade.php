        ...
        <div class="px-6 py-6 text-center">
            ...
            <div class="flex flex-col sm:flex-row gap-3 justify-center">
                <form action="{{ route('logout') }}" method="POST">
                    @csrf
                    <button type="submit" class="cursor-pointer px-6 py-3 bg-gray-100 hover:bg-gray-200 text-gray-700 rounded-lg font-medium transition-colors duration-300">
                        Return Home
                    </button>
                </form>
                <a href="mailto:douskary.wissam@gmail.com" class="px-6 py-3 bg-yellow-500 hover:bg-yellow-600 text-white rounded-lg font-medium transition-colors duration-300">
                    Contact Support
                </a>
            </div>
        </div>
