...
@section('content')
    ...
    <section class="relative h-screen">
        ...
        <div class="relative h-full flex flex-col justify-center px-8 max-w-6xl mx-auto">
            <div class="text-white">
                <h1 class="text-5xl font-bold font-poppins mb-4">
                    Solid Foundation For A<br />
                    Brighter Future!
                </h1>
                <p class="text-xl mb-8">Construction structuring</p>
                <div class="flex gap-4">
                    <a href=""><button
                            class="bg-amber-400 text-white px-10 py-3 hover:bg-amber-500 cursor-pointer duration-200">
                            Products
                        </button></a>
                    <a href="{{ route('About') }}"><button
                            class="bg-white text-gray-800 px-10 py-3 hover:bg-gray-100 cursor-pointer duration-200">
                            About
                        </button></a>
                </div>
            </div>
    ...
    <section class="py-20 px-8" data-aos="fade-up"
    data-aos-anchor-placement="top-bottom">
        <div class="max-w-6xl mx-auto grid grid-cols-2 gap-16">
            ...
            <h2 class="text-3xl font-bold text-gray-900 mb-6 ">About Brick Base Company</h2>
        </div>
        </div>
    </section>

    <!-- Services Section -->
    <section class="py-20 px-8 bg-white" data-aos="fade-up"
    data-aos-anchor-placement="top-bottom">
        <div class="max-w-6xl mx-auto">
            <div class="grid grid-cols-4 gap-8">

                <div class="bg-white py-8 px-10 rounded-lg shadow-lg text-center hover:shadow-xl transition-shadow">
    ...
    <section class="grid grid-cols-2 mb-16" data-aos="fade-up"
    data-aos-anchor-placement="top-bottom">
        <div class="h-[550px]">
            <img class="w-full h-full" src="{{ asset('storage/photos/helmet.png') }}" alt="helmet photo">
        </div>
