...
@section('content')
    <section class="relative h-40 md:h-64 overflow-hidden">
        ...
        <!-- Hero Content -->
        <div class="container mx-auto px-4 h-full flex flex-col justify-center items-start sm:items-center md:items-start ml-0 sm:ml-0 md:ml-6 relative z-10">
            <h1 class="text-white text-2xl sm:text-3xl md:text-5xl font-bold text-center sm:text-center md:text-left">Our Workers</h1>
            <p class="text-gray-200 text-xs sm:text-sm md:text-base text-center sm:text-center md:text-left mb-2">Home > Our Workers</p>
        </div>
    </section>
    ...
    <div class="container mx-auto px-4 py-6">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-10 lg:gap-20 mt-8 sm:mt-12 lg:mt-20">
            <div class="bg-white shadow-md rounded-lg overflow-hidden">
                <div class="relative">
                    <img src="{{ asset('storage/photos/Ourworkers.png') }}" alt="Worker" class="w-full h-60 sm:h-72 object-cover">
                    <div class="absolute bottom-0 left-0 right-0 bg-yellow-500 bg-opacity-50 text-white p-1 w-1/2 text-xs sm:text-sm">
                        Ceramics and Stone Materials
                    </div>
                </div>
                <div class="p-3 sm:p-4">
                    <h3 class="text-base sm:text-lg font-bold">ADESILEX P9</h3>
                    <div class="flex items-center mb-2">
                        <div class="text-yellow-500 text-sm sm:text-base">★★★★½</div>
                        <span class="ml-2 text-gray-600 text-xs sm:text-sm">4.5/5</span>
                    </div>
                    <p class="text-gray-600 mb-4 text-xs sm:text-sm">High-performance cementitious adhesive with no vertical slip and extended
                    ...
                    <div class="flex justify-between items-center">
                        <a href="{{route('Preview')}}" class="inline-flex items-center text-blue-600 hover:text-blue-800 text-xs sm:text-sm">
                            View Details
    ...
    <div class="flex justify-center mt-8 md:mt-10 px-2">
        <nav class="inline-flex flex-wrap justify-center rounded-md shadow">
            <a href="#" class="py-2 px-2 sm:px-4 border border-gray-300 bg-white rounded-l-md text-xs sm:text-sm font-medium text-gray-700 hover:bg-gray-50 flex items-center">
                <svg xmlns="http://www.w3.org/2000/svg" class="h-3 w-3 sm:h-4 sm:w-4 mr-0 sm:mr-1 inline-block" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 19l-7-7 7-7" />
                </svg>
                <span class="hidden sm:inline">Previous</span>
            </a>
            <a href="#" class="py-2 px-3 sm:px-4 border border-gray-300 text-yellow-400 text-white text-xs sm:text-sm font-medium">1</a>
            <a href="#" class="py-2 px-3 sm:px-4 border border-gray-300 bg-white text-xs sm:text-sm font-medium text-gray-700 hover:bg-gray-50">2</a>
            <a href="#" class="py-2 px-3 sm:px-4 border border-gray-300 bg-white text-xs sm:text-sm font-medium text-gray-700 hover:bg-gray-50 hidden xs:inline-block">3</a>
            <span class="py-2 px-3 sm:px-4 border border-gray-300 bg-white text-xs sm:text-sm font-medium text-gray-700 hidden sm:inline-block">...</span>
            <a href="#" class="py-2 px-3 sm:px-4 border border-gray-300 bg-white text-xs sm:text-sm font-medium text-gray-700 hover:bg-gray-50 hidden md:inline-block">67</a>
            <a href="#" class="py-2 px-3 sm:px-4 border border-gray-300 bg-white text-xs sm:text-sm font-medium text-gray-700 hover:bg-gray-50">68</a>
            <a href="#" class="py-2 px-2 sm:px-4 border border-gray-300 bg-white rounded-r-md text-xs sm:text-sm font-medium text-gray-700 hover:bg-gray-50 flex items-center">
                ...
                <svg xmlns="http://www.w3.org/2000/svg" class="h-3 w-3 sm:h-4 sm:w-4 ml-0 sm:ml-1 inline-block" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5l7 7-7 7" />
                </svg>
            </a>
        </nav>
