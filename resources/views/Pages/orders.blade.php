                                ...
                                <div class="flex items-start">
                                    ...
                                    <div class="flex-1">
                                        <div class="flex justify-between items-start mb-1">
                                            ...
                                            <span class="text-lg font-bold text-amber-500">${{ number_format($order->price * $order->quantity, 2) }}</span>
                                        </div>
                            ...
                            <div
                                ...
                                <div class="space-y-4">
                                    <div class="flex items-center space-x-4 pb-4 border-b">
                                        <img src="{{ asset('storage/' . $order->product->main_image . '') }}" alt="{{ $order->product->title }}" class="w-16 h-16 rounded-md object-cover">
                                        <div>
                                    ...
                                    <div class="flex items-center justify-between pt-2 border-t">
                                        ...
                                        <p class="font-bold text-amber-500">${{ number_format(($order->price * $order->quantity) + 5.99, 2) }}</p>
                                    </div>
                                    ...
                                    <div class="pt-4 border-t">
                                        ...
                                        <div class="flex items-center">
                                            <img class="w-7 text-blue-600 mr-2" src="{{ asset('storage/photos/paypal.svg') }}" alt="PayPal logo">
                                            <span>PayPal</span>
                                        </div>
                                    </div>
                                </div>
                ...
                @else
                    <div class="bg-white rounded-lg shadow-sm border border-gray-100 p-6 text-center">
                        <div class="flex flex-col items-center justify-center py-6">
                            ...
                            <a href="{{ route('Products') }}" class="text-amber-500 hover:text-amber-600 font-medium">Start Shopping</a>
                        </div>
                    </div>
                @endif
            </div>
        ...
        <div class="max-w-4xl mx-auto">
            <div class="flex items-center justify-between">
                <div class="flex items-center">
                    ...
                    <div>
                        <span class="text-sm text-gray-500">Total ({{ count($orders) }} items):</span>
                        <span class="ml-2 font-bold text-lg">${{ $total }}</span>
                    </div>
                </div>
                <button class="bg-amber-500 hover:bg-amber-600 text-white px-6 py-2 rounded-md font-medium transition-colors">
                    Checkout All
                </button>
            </div>
        </div>
