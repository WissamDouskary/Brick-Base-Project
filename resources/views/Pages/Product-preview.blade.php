...
<section class="relative h-40 md:h-64 overflow-hidden">
    ...
    <div class="container mx-auto px-4 h-full flex flex-col justify-center items-start ml-6 relative z-10">
        <h1 class="text-white text-3xl md:text-5xl font-bold text-center">Product</h1>
        <p class="text-gray-200 text-sm md:text-base text-center mb-2">Home > Products > Product</p>
    </div>
</section>
...
<div class="container mx-auto px-4 py-8 max-w-6xl">
    ...
    <section class="mb-12">
        <div class="text-start mb-2">
            ...
            <h1 class="text-3xl font-bold text-gray-800 mt-1">Product</h1>
        </div>

        <div class="flex flex-col md:flex-row mt-6 gap-8">
            <div class="md:w-1/2">
                <p class="text-gray-700">
                    Product is a grey or white powder composed of cement, sands of selected granulometry, synthetic resins and special admixtures according to a formula developed in MAPEI's Research Laboratories.
                </p>
            ...
            <div class="md:w-1/2 mt-6 md:mt-0">
                <div class="relative">
                    <img src="{{ asset('storage/photos/sima.png') }}" alt="Workers applying Keraset" class="w-full h-2/4 rounded-md shadow-md"/>
        ...
        <div class="mt-10">
            ...
            <div class="flex justify-end gap-4">
                <img src="{{ asset('storage/photos/sima.png') }}" alt="Thumbnail 1" class="w-24 h-20 object-cover rounded border border-gray-300 cursor-pointer hover:border-yellow-400"/>
                <img src="{{ asset('storage/photos/sima.png') }}" alt="Thumbnail 2" class="w-24 h-20 object-cover rounded border border-gray-300 cursor-pointer hover:border-yellow-400"/>
                <img src="{{ asset('storage/photos/sima.png') }}" alt="Thumbnail 3" class="w-24 h-20 object-cover rounded border border-gray-300 cursor-pointer hover:border-yellow-400"/>
                <img src="{{ asset('storage/photos/sima.png') }}" alt="Thumbnail 4" class="w-24 h-20 object-cover rounded border border-gray-300 cursor-pointer hover:border-yellow-400"/>
                <img src="{{ asset('storage/photos/sima.png') }}" alt="Thumbnail 5" class="w-24 h-20 object-cover rounded border border-gray-300 cursor-pointer hover:border-yellow-400"/>
            </div>
        </div>
    </section>
        ...
        <div class="relative">
            ...
            <div class="flex flex-wrap md:flex-nowrap gap-6 mx-10">
                ...
                <div class="w-full md:w-1/3">
                    <div class="relative">
                        <img src="{{ asset('storage/photos/sima.png') }}" alt="ISOLASTIC" class="w-full h-auto rounded-md shadow-md"/>
                        <span class="absolute bottom-3 right-3 bg-yellow-400 text-white text-xs px-2 py-1 rounded-sm">
                            Ceramics and Stone Material
                        </span>
                    </div>
                ...
                <div class="w-full md:w-1/3">
                    <div class="relative">
                        <img src="{{ asset('storage/photos/sima.png') }}" alt="FUGA FRESCA" class="w-full h-auto rounded-md shadow-md"/>
                        <span class="absolute bottom-3 right-3 bg-yellow-400 text-white text-xs px-2 py-1 rounded-sm">
                            Ceramics and Stone Material
                        </span>
                    </div>
