<footer class="bg-white py-12 px-6">
    ...
    <div class="max-w-6xl mx-auto grid grid-cols-4 gap-8">
        ...
        <div class="col-span-1">
            ...
            <div class="text-sm">
                <p>Email: <a href="mailto:info@brick-base.com" class="text-amber-400">info@brick-base.com</a></p>
                <p>Phone: <a href="tel:+218123123456" class="text-amber-400">+218 12-3123456</a></p>
            </div>
        </div>
        ...
        <div class="col-span-1">
            ...
            <ul class="space-y-2 text-sm text-gray-600">
                ...
                <li><a href="#" class="hover:text-gray-900">Sealants</a></li>
                <li><a href="#" class="hover:text-gray-900">Sport Flooring</a></li>
                <li><a href="#" class="hover:text-gray-900">Sport Flooring Solutions</a></li>
            </ul>
        </div>
        ...
        <div class="col-span-1">
            ...
            <ul class="space-y-2 text-sm text-gray-600">
                ...
                <li><a href="#" class="hover:text-gray-900">Power Generation</a></li>
                <li><a href="#" class="hover:text-gray-900">Food & Beverage</a></li>
                <li><a href="#" class="hover:text-gray-900">Oil & Gas</a></li>
            </ul>
        </div>
    </div>
